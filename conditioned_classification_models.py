...
def cnn_2x_gru_siamese(voc_size, max_len, dropout=0.5):
    """Two siamese branches, each embedding a statement.
    Binary classifier on top.
    Args:
      voc_size: size of the vocabulary for the input statements.
...
MODELS = {
    ...
    'cnn_2x_rnn_siamese': (cnn_2x_rnn_siamese, 'integer'),
    'cnn_2x_gru_siamese': (cnn_2x_gru_siamese, 'integer'),
    'cnn_2x_encdec_siamese': (cnn_2x_encdec_siamese, 'integer'),
}
